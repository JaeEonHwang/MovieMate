<template>
	<div>
        ...
        <!-- <template v-if="movie.images.length > 0 && movie.images[0].type === 1"> -->
          <li>
            <iframe  width="341" height="191" :src="video.youtube_path" frameborder="0" allowfullscreen></iframe>
            <!-- <v-card
              class="item"
              theme="dark"
              ...
              <!-- <div class="card"> -->
                ...
                <!-- <div class="card-title px-3" style="color: rgba(255, 255, 255, 0.9); background-color: rgba(0, 0, 0, 0.4);">{{ movie.title }}</div> -->
              <!-- </div> -->
            <!-- </v-card> -->
          </li>
        </template>
